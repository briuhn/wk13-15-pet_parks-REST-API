...
public class PetStoreController {
	...
	public PetStoreCustomer saveCustomer(@PathVariable Long petStoreId, @RequestBody PetStoreCustomer petStoreCustomer) {
		log.info("Creating pet_store_customer {}", petStoreCustomer);
